...
fun main() {
    ...
    try {
        val token = requireNotNull(apiResponse["Token"]) {
            "CRITICAL EXCEPTION: Token otentikasi tidak ditemukan dari server1"
        }
    ...
    val statusLenght = javaResponse!!.length
    println("Status dari java: $javaResponse (Length: $statusLenght) ")
